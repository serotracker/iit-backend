...
class ResearchSourceSchema(Schema):
    ...
    age_variation = fields.Str(validate=validate.Length(max=128), allow_none=True)
    age_variation_measure = fields.Str(validate=validate.Length(max=64), allow_none=True)
    average_age = fields.Str(validate=validate.Length(max=256), allow_none=True)
    ...
    ind_eval_lab = fields.Str(validate=validate.Length(max=128), allow_none=True)
    ...
    jbi_1 = fields.Str(validate=validate.Length(max=16), allow_none=True)
    jbi_2 = fields.Str(validate=validate.Length(max=16), allow_none=True)
    jbi_3 = fields.Str(validate=validate.Length(max=16), allow_none=True)
    jbi_4 = fields.Str(validate=validate.Length(max=16), allow_none=True)
    jbi_5 = fields.Str(validate=validate.Length(max=16), allow_none=True)
    jbi_6 = fields.Str(validate=validate.Length(max=16), allow_none=True)
    jbi_7 = fields.Str(validate=validate.Length(max=16), allow_none=True)
    jbi_8 = fields.Str(validate=validate.Length(max=16), allow_none=True)
    jbi_9 = fields.Str(validate=validate.Length(max=16), allow_none=True)
    measure_of_age = fields.Str(validate=validate.Length(max=64), allow_none=True)
    ...
    subgroup_var = fields.Str(validate=validate.Length(max=128), allow_none=True)
    subgroup_cat = fields.Str(validate=validate.Length(max=128), allow_none=True)
    superceded = fields.Boolean(allow_none=True)
    test_linked_uid = fields.Str(allow_none=True)
    test_name = fields.Str(allow_none=True)
    test_validation = fields.Str(validate=validate.Length(max=128), allow_none=True)
