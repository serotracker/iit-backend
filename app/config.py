...
class ApiConfig:
    ...
    AIRTABLE_SAMPLE_FRAME_GOI_OPTIONS_REQUEST_URL = "https://api.airtable.com/v0/{}/Sample%20Frame%20GOI?fields=Order&fields=Name&sort%5B0%5D%5Bfield%5D=Order&fields=French%20Name&fields=German%20Name".format(AIRTABLE_BASE_ID)
    GITHUB_CSV_FIELDS_REQUEST_URL = "https://api.airtable.com/v0/{}/Airtable%20SOP?view=viwJSA16MpcZtfYt5".format(AIRTABLE_BASE_ID)
    BIBLIO_CSV_FIELDS_REQUEST_URL = "https://api.airtable.com/v0/{}/Airtable%20SOP?view=viwoU78Kghka2EMsh".format(AIRTABLE_BASE_ID)
