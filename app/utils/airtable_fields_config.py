dashboard_fields = ['Source Name', 'Publication Date', 'First Author Full Name', 'Organizational Author', 'URL',
                    ...
                    'Test Manufacturer', 'Approved by Regulator?', 'Test Type', 'Specimen Type', 'Isotype(s) Reported',
...
research_fields = ['Source Name', 'Publication Date', 'First Author Full Name', 'Organizational Author', 'URL',
                   'Source Type', 'Source Publisher', 'One-Line Summary', 'Study Type', 'Country',
                   'Lead Organization', 'State/Province', 'County/City', 'Sampling Start Date', 'Sampling End Date',
                   'Sample Frame (sex)', 'Sample Frame (age)', 'Sample Frame (groups of interest)', 'Sampling Method',
                   'Test Manufacturer', 'Approved by Regulator?', 'Test Type', 'Specimen Type', 'Isotype(s) Reported',
...
full_airtable_fields = {
    ...
    'Approved by Regulator?': 'approved_by_regulator',
    'Test Type': 'test_type',
